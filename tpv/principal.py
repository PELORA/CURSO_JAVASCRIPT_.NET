...
class Ventana(): 
    ...
    def componentes(self,ventana):
        ...
        self.art=StringVar(value="")
        self.dia=StringVar(value='00')
        self.mes=StringVar(value='00')
        self.año=StringVar(value='00')
        #campo fecha
        etFecha=Label(self.ventana,text="Fecha (dd/mm/hh)",bg=self.colorFondo3,fg=self.colorLetra).place(x=20,y=15)
        cjDia=Entry(self.ventana,textvariable=self.dia).place(x=165,y=15,width=20)
        cjMes=Entry(self.ventana,textvariable=self.mes).place(x=190,y=15,width=20)
        cjAño=Entry(self.ventana,textvariable=self.año).place(x=215,y=15,width=50)
        #tienda01
        etTienda01=Label(self.ventana,text="Libro Tienda 01",bg=self.colorFondo,fg=self.colorLetra).place(x=85,y=40)
        ...
        #tienda02
        etTienda02=Label(self.ventana,text="Libro Tienda 02",bg=self.colorFondo,fg=self.colorLetra).place(x=185,y=40)
        ...
        botonGuardar=Button(self.ventana,text="Guardar",command=self.guardar,bg=self.colorFondo2,fg=self.colorLetra).place(x=110,y=165)
        botonBorrar=Button(self.ventana,text="Borrar",command=self.borrar,bg=self.colorFondo2,fg=self.colorLetra).place(x=180,y=165)
        #Informes
        self.dia1=StringVar(value='00')
        self.mes1=StringVar(value='00')
        self.año1=StringVar(value='00')
        etInforme=Label(self.ventana,text="Ventas entre fechas indicadas",bg=self.colorFondo,fg=self.colorLetra).place(x=20,y=230)
        etart=Label(self.ventana,text="Articulo",bg=self.colorFondo3,fg=self.colorLetra).place(x=20,y=200)
        cjart=Entry(self.ventana,textvariable=self.art).place(x=90,y=200,width=170)
        etFecha1=Label(self.ventana,text="Fecha inicial",bg=self.colorFondo,fg=self.colorLetra).place(x=20,y=260)
        cjDia1=Entry(self.ventana,textvariable=self.dia1).place(x=100,y=260,width=20)
       
        cjMes1=Entry(self.ventana,textvariable=self.mes1).place(x=130,y=260,width=20)
        cjAño1=Entry(self.ventana,textvariable=self.año1).place(x=160,y=260,width=20)        
        self.dia2=StringVar(value='00')
        self.mes2=StringVar(value='00')
        self.año2=StringVar(value='00')
        etFecha1=Label(self.ventana,text="Fecha final",bg=self.colorFondo,fg=self.colorLetra).place(x=20,y=290)
        cjDia1=Entry(self.ventana,textvariable=self.dia2).place(x=100,y=290,width=20)
        cjMes1=Entry(self.ventana,textvariable=self.mes2).place(x=130,y=290,width=20)
        cjAño1=Entry(self.ventana,textvariable=self.año2).place(x=160,y=290,width=20)       
        botonMostrar=Button(self.ventana,text="Mostrar",command=self.mostrar,bg=self.colorFondo2,fg=self.colorLetra).place(x=200,y=275)
    ...
    def mostrar(self):
        ...
        #venta por libro
        Libros=ventaTienda(self.di1,self.me1,self.an1,self.di2,self.me2,self.an2)
        
        textoMensaje="La venta total es de "+str(Total)+"\n"
        textoMensaje=textoMensaje+"Tienda 01\tTienda 02\n"
        textoMensaje=textoMensaje+str(Libros['TIENDA 01'])+"\t\t"+str(Libros['TIENDA 02'])
    ...
    def guardar(self):
        ...
        self.texto=self.texto+"\tLibros Vendidos = "+str((self.art.get()))+"\n\n"
